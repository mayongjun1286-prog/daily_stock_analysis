...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "MARKET_REVIEW_REGION": {
        ...
        "description": "Market region for review: us (US stocks), jp (Japan), kr (Korea), or both (all configured markets).",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "is_editable": True,
        "default_value": "us",
        "options": ["us", "jp", "kr", "both"],
        "validation": {"allowed_values": ["us", "jp", "kr", "both"], "delimiter": ","},
        "display_order": 48,
        "help_key": "settings.system.market_review",
        "examples": [
